...
#define RHO_K_TARGET        0.1//RHO_K_TARGET_IND+(10/RHO_SQRT_HEIGHT*RHO_DIM_INFLUENCE)
#define RHO_VARIANCE_NORMAL 12.//RHO_SQRT_HEIGHT/5.0
#define RHO_VARIANCE_SCALE  15.//RHO_SQRT_HEIGHT/3.0//1.32
