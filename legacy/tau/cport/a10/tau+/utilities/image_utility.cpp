...
ImageUtility::ImageUtility( std::string n, std::string f = "", int num = 0, int width = FNL_RESIZE_W, int height = FNL_RESIZE_H) :
num_frames(num), size(width, height), name(n), subdir(f),
frame(Size(FNL_RESIZE_W, FNL_RESIZE_H), CV_8UC3, Scalar(0,0,0)),
preoutframe(Size(FNL_RESIZE_W, FNL_RESIZE_H), CV_8UC3, Scalar(0,0,0)),
outframe(Size(FNL_RESIZE_W, FNL_RESIZE_H), CV_8UC3, Scalar(0,0,0)),
image(Size(FNL_RESIZE_W, FNL_RESIZE_H), CV_8UC3, Scalar(0,0,0))
#ifdef HAS_CAMERA
,cam(CAMERA_ID)
