...
#define INTERRUPT_CHANNEL APPLICATION_QUEUE_ID_HW_INTERRUPTS
...
typedef enum
{
    APPLICATION_QUEUE_ID_HW_INTERRUPTS = 0,
    APPLICATION_SYSTEM_QUEUE_ID_COMM_MESSAGES,
    APPLICATION_SYSTEM_QUEUE_ID_RUNTIME_MESSAGES,
    APPLICATION_SYSTEM_QUEUE_ID_APPLICATION_MESSAGES,

    NUM_APPLICATION_QUEUES
} APPLICATION_QUEUE_ID, application_queue_id_t;
...
#define APPLICATION_COMPONENT_RHO_MODULE_SECONDARY       COMPONENT_ID(COMPONENT_TYPE_SENSOR, APPLICATION_SENSOR_RHO_MODULE_SECONDARY)
...
#define APPLICATION_COMPONENT_BLE_RADIO_PRIMARY          COMPONENT_ID(COMPONENT_TYPE_DRIVER, APPLICATION_DRIVER_BLE_RADIO)
#define APPLICATION_COMPONENT_SUB_RADIO_PRIMARY          COMPONENT_ID(COMPONENT_TYPE_DRIVER, APPLICATION_DRIVER_SUB_RADIO)
