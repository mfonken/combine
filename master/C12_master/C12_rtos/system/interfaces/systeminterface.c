...
void CreateSystemInterfaceOSTask( os_task_data_t * task_data )
{
    ...
    LOG_SYSTEM(SYSTEM_DEBUG, "Creating OS Task: %s\n", task_id_strings[task_data->ID]);
...
{
    LOG_SYSTEM(SYSTEM_DEBUG, "Resuming OS Task: %s\n", task_id_strings[task_data->ID]);
...
{
    LOG_SYSTEM(SYSTEM_DEBUG, "Suspending OS Task: %s\n", task_id_strings[task_data->ID]);
...
{
    LOG_SYSTEM(SYSTEM_DEBUG, "Deleting OS Task: %s\n", task_id_strings[task_data->ID]);
//    OSTaskDelete()
}
