...
#define Families_ALL { SYSTEM_FAMILY_D, SYSTEM_FAMILY_C, SYSTEM_FAMILY_B, SYSTEM_FAMILY_A, SYSTEM_FAMILY_0 }
#define Families_ERROR { SYSTEM_FAMILY_C, SYSTEM_FAMILY_B, SYSTEM_FAMILY_0 }

/* Channels */
#define Channels_I2C { I2C2, I2C1 }
#define Channels_SPI { SPI2, SPI1 }
#define Channels_USART { USART2, USART1 }

/* Components */
#define EFR32_BLE_ID APPLICATION_COMPONENT_BLE_RADIO_PRIMARY
#define EFR32_BLE_FAMILY SYSTEM_FAMILY_A
#define EFR32_BLE_PROTOCOL COMM_PROTOCOL_BLE
...
#define EFR32_BLE_Components { EFR32_BLE_ID, EFR32_BLE_FAMILY, EFR32_BLE_PROTOCOL, EFR32_BLE_ROUTE, EFR32_BLE_ADDR, EFR32_BLE_PORT, EFR32_BLE_PIN, EFR32_BLE_STATE }

#define EFR32_SUB_ID APPLICATION_COMPONENT_SUB_RADIO_PRIMARY
#define EFR32_SUB_FAMILY SYSTEM_FAMILY_B
#define EFR32_SUB_PROTOCOL COMM_PROTOCOL_SUB
...
#define EFR32_SUB_Components { EFR32_SUB_ID, EFR32_SUB_FAMILY, EFR32_SUB_PROTOCOL, EFR32_SUB_ROUTE, EFR32_SUB_ADDR, EFR32_SUB_PORT, EFR32_SUB_PIN, EFR32_SUB_STATE }

#define BNO080_ID APPLICATION_COMPONENT_MOTION_PRIMARY
#define BNO080_FAMILY SYSTEM_FAMILY_B
#define BNO080_PROTOCOL COMM_PROTOCOL_SPI
...
#define BNO080_Components { BNO080_ID, BNO080_FAMILY, BNO080_PROTOCOL, BNO080_ROUTE, BNO080_ADDR, BNO080_PORT, BNO080_PIN, BNO080_STATE }

#define RHOMOD_ID APPLICATION_COMPONENT_RHO_MODULE_PRIMARY
#define RHOMOD_FAMILY SYSTEM_FAMILY_0
#define RHOMOD_PROTOCOL COMM_PROTOCOL_I2C
...
#define RHOMOD_Components { RHOMOD_ID, RHOMOD_FAMILY, RHOMOD_PROTOCOL, RHOMOD_ROUTE, RHOMOD_ADDR, RHOMOD_PORT, RHOMOD_PIN, RHOMOD_STATE }
...
#define STC310_Components { STC310_ID, STC310_FAMILY, STC310_PROTOCOL, STC310_ROUTE, STC310_ADDR, STC310_PORT, STC310_PIN, STC310_STATE }

#define XC9265_ID APPLICATION_COMPONENT_REGULATOR_1V5
#define XC9265_FAMILY SYSTEM_FAMILY_A
#define XC9265_PROTOCOL COMM_PROTOCOL_NONE
...
#define XC9265_Components { XC9265_ID, XC9265_FAMILY, XC9265_PROTOCOL, XC9265_ROUTE, XC9265_ADDR, XC9265_PORT, XC9265_PIN, XC9265_STATE }
...
#define APPLICATION_TASK_SHELF_ENTRY_SENSOR_RHO_TASKS { \
    ...
    .interrupts = NONE, \
    .num_interrupts = NONE, \
    .scheduled = { APPLICATION_SCHEDULER_RHO_INTERRUPT }, \
    .num_scheduled = 1 \
}
...
#define APPLICATION_TASK_SHELF_ENTRY_COMMUNICATION_HOST_RADIO_TASKS { \
    ...
    .interrupts = { APPLICATION_INTERRUPTER_TAU_PACKET_RECEIVE }, \
    .num_interrupts = 1, \
    .scheduled = { APPLICATION_INTERRUPTER_TAU_PACKET_TRANSMIT }, \
    .num_scheduled = 1 \
}
