...
SYSTEM_PROFILE_ENTRY_DIRECTION_OUTPUT, \
SYSTEM_PROFILE_ENTRY_TYPE_SCHEDULED, }, \
SYSTEM_SENSOR_BATTERY_MONITOR_PRIMARY, \
...
SYSTEM_PROFILE_ENTRY_DIRECTION_INPUT, \
SYSTEM_PROFILE_ENTRY_TYPE_SCHEDULED, }, \
SYSTEM_SENSOR_RHO_MODULE_PRIMARY, \
...
#define SYSTEM_TASK_SHELF_ENTRY_NULL_ENTRY { \
...
#define SYSTEM_TASK_SHELF_ENTRY_SENSOR_MOTION_TASKS_ENTRY { \
SYSTEM_TASK_SHELF_ENTRY_ID_SENSOR_MOTION_TASKS, \
2, { \
SYSTEM_SENSOR_MOTION_PRIMARY_WAKE_ENTRY, \
SYSTEM_SENSOR_MOTION_PRIMARY_INTERRUPT_ENTRY \
}, \
0, { \
} } \

#define SYSTEM_TASK_SHELF_ENTRY_SENSOR_TOUCH_TASKS_ENTRY { \
...
#define SYSTEM_TASK_SHELF_ENTRY_SENSOR_TIP_TASKS_ENTRY { \
SYSTEM_TASK_SHELF_ENTRY_ID_SENSOR_TIP_TASKS, \
0, { \
}, \
1, { \
SYSTEM_SENSOR_TIP_SCHEDULED_PROBE_ENTRY \
} } \

#define SYSTEM_TASK_SHELF_ENTRY_SENSOR_BATTERY_MONITOR_TASKS_ENTRY { \
SYSTEM_TASK_SHELF_ENTRY_ID_SENSOR_BATTERY_MONITOR_TASKS, \
0, { \
}, \
1, { \
SYSTEM_SENSOR_BATTERY_MONITOR_SCHEDULED_PROBE_ENTRY \
} } \

#define SYSTEM_TASK_SHELF_ENTRY_SENSOR_RHO_TASKS_ENTRY { \
SYSTEM_TASK_SHELF_ENTRY_ID_SENSOR_RHO_TASKS, \
0, { \
}, \
1, { \
SYSTEM_SENSOR_RHO_SCHEDULED_RECEIVE_PACKET_ENTRY \
} } \

#define SYSTEM_TASK_SHELF_ENTRY_DRIVER_HAPTIC_PRIMARY_TASKS_ENTRY { \
SYSTEM_TASK_SHELF_ENTRY_ID_DRIVER_HAPTIC_PRIMARY_TASKS, \
1, { \
SYSTEM_DRIVER_HAPTIC_PRIMARY_TRIGGER_ENTRY \
}, \
0, { \
} } \

#define SYSTEM_TASK_SHELF_ENTRY_COMMUNICATION_HOST_RADIO_TASKS_ENTRY { \
SYSTEM_TASK_SHELF_ENTRY_ID_COMMUNICATION_HOST_RADIO_TASKS, \
1, { \
SYSTEM_COMMUNICATION_HOST_RECEIVE_PACKET_INTERRUPT_ENTRY \
}, \
1, { \
SYSTEM_COMMUNICATION_HOST_SCHEDULED_TRANSMIT_PACKET_ENTRY \
} } \

#define SYSTEM_TASK_SHELF_ENTRY_COMMUNICATION_SUB_RADIO_TASKS_ENTRY { \
SYSTEM_TASK_SHELF_ENTRY_ID_COMMUNICATION_SUB_RADIO_TASKS, \
2, { \
SYSTEM_COMMUNICATION_SUB_RECEIVE_PACKET_INTERRUPT_ENTRY, \
SYSTEM_COMMUNICATION_SUB_TRANSMIT_PACKET_INTERRUPT_ENTRY \
}, \
0, { \
} } \
...
{
    { /* Task Shelf */
        SYSTEM_TASK_SHELF_ENTRY_NULL_ENTRY,
        SYSTEM_TASK_SHELF_ENTRY_SENSOR_MOTION_TASKS_ENTRY,
        SYSTEM_TASK_SHELF_ENTRY_SENSOR_TOUCH_TASKS_ENTRY,
        SYSTEM_TASK_SHELF_ENTRY_SENSOR_TIP_TASKS_ENTRY,
        SYSTEM_TASK_SHELF_ENTRY_SENSOR_BATTERY_MONITOR_TASKS_ENTRY,
        SYSTEM_TASK_SHELF_ENTRY_SENSOR_RHO_TASKS_ENTRY,
        SYSTEM_TASK_SHELF_ENTRY_DRIVER_HAPTIC_PRIMARY_TASKS_ENTRY,
        SYSTEM_TASK_SHELF_ENTRY_COMMUNICATION_HOST_RADIO_TASKS_ENTRY,
        SYSTEM_TASK_SHELF_ENTRY_COMMUNICATION_SUB_RADIO_TASKS_ENTRY
    },
    { /* State Profiles */
